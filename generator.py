...
@app.route('/')
def index():
    return render_template('index.jinja2', lang=pt_lang, config=config,
                           works=pt_works)
...
@app.route('/en/')
def index_en():
    return render_template('index.jinja2', lang=en_lang, config=config,
                           works=en_works)
